    ...
    <script type="text/javascript">
        function ChooseCustomer() {
            $.dialog({ title: '选择线材', width: '800px', heght: '600px',
                content: 'url:MaterialSetting/chooseMaterial.aspx?txtTarget=hidName&idTarget=hidMaterialID',
                lock: true
            });
        }
    </script>
...
<body class="mainbody">
    ...
    <div class="tab-content">
     ...
     <%--           <asp:Timer ID="Timer2" runat="server" Interval="1000" ></asp:Timer>--%>
                    ...
                    <asp:HiddenField ID="hidMaterialID" runat="server" /><asp:HiddenField ID="hidName" runat="server" />
                </ContentTemplate>
                </asp:UpdatePanel>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    <td><asp:HiddenField ID="hfdID" runat="server" Value='<%#Eval("InnerID") %>' />
                        <%# Eval("Brand")%>
                    </td>
                    <td>
                        <%# Eval("Mode")%>

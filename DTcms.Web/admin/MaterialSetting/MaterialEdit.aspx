...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ChooseCustomer() {
            $.dialog({
                title: '选择线材', width: '800px', heght: '600px',
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <HeaderTemplate>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                            <tr>
                                <th style="width: 10%" align="center">品牌
                                </th>
                                <th style="width: 10%" align="center">型号
                                </th>
                                <th style="width: 10%" align="center">品名
                                </th>
                                <th style="width: 50%" align="center">产品描述
                                </th>
                                <th align="center" align="center">单位
                                </th>
                                <th style="width: 10%" align="center">数量
                                </th>
                                <th align="center">操作
                                </th>
                            </tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                                <asp:HiddenField ID="hfdID" runat="server" Value='<%#Eval("InnerID") %>' />
                                <%# Eval("Brand")%>
                            </td>
                            <td align="center">
                                <%# Eval("Mode")%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialPriceList.aspx.cs" Inherits="DTcms.Web.admin.MaterialSetting.MaterialPriceList" %>
            ...
            <asp:Repeater ID="rptList1" runat="server">
                ...
                <ItemTemplate>
                    <tr height="80">
                        ...
                        <td align="center">
                            <a href='MaterialPriceEdit.aspx?action=Edit&id=<%#Eval("ID") %>'>编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialCostEdit.aspx.cs" Inherits="DTcms.Web.admin.MaterialSetting.MaterialCostEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:;" class="home"><i></i><span>成本价设置</span></a>
        </div>
        <!--/导航栏-->
        <!--内容-->
...
<%--                    <asp:TextBox ID="txtName" runat="server" CssClass="input normal" sucmsg=" " minlength="1"
            ...
            <dl>
                <dt style="color:red">成本价：</dt>
                <dd>
                    <asp:TextBox ID="txtCostPrice" runat="server" CssClass="input normal" sucmsg=" " minlength="1"
                        MaxLength="100"></asp:TextBox>

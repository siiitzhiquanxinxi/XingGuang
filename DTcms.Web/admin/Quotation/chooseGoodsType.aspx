<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chooseGoodsType.aspx.cs" Inherits="DTcms.Web.admin.Quotation.chooseGoodsType" %>
            ...
            <asp:Repeater ID="rptList1" runat="server">
                <HeaderTemplate>
                    <table border="0" cellspacing="0" cellpadding="0" class="ltable" style="width: 450px;">
                        <tr>
                            <th align="left" style="padding-left: 5px;">产品分类</th>
                            <th width="35%">操作</th>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>

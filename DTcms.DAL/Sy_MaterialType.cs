...
namespace DTcms.DAL
{
	...
	public partial class Sy_MaterialType
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(DTcms.Model.Sy_MaterialType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Sy_MaterialType(");
            strSql.Append("MaterialType)");
        ...
        /// 得到一个对象实体
        /// </summary>
        public DTcms.Model.Sy_MaterialType GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,MaterialType from Sy_MaterialType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,MaterialType ");
